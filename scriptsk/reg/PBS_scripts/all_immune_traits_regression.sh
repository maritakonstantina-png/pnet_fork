...
FREE_GPU=""
while [ -z "$FREE_GPU" ]; do
    FREE_GPU=$(python /shares/CIBIO-Storage/BCG/scratch/kmarita/code/pnet_fork/scriptsk/reg/PBS_scripts/get_gpu.py)
...
# SCRIPT
python /shares/CIBIO-Storage/BCG/scratch/kmarita/code/pnet_fork/scriptsk/reg/regression_immune_traits.py parameters.trait=$immune_trait parameters.score_type=$score_type runtime.output_dir=$output_dir $hydra_args
