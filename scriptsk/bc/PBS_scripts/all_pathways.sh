...
output_dir='/shares/CIBIO-Storage/BCG/scratch/kmarita/data/pnet_fork/bc/'$pathway'/'$score_type'/script_output_'$timestamp'/'
mkdir -p $output_dir
#set 
...
FREE_GPU=""
while [ -z "$FREE_GPU" ]; do
    FREE_GPU=$(python /shares/CIBIO-Storage/BCG/scratch/kmarita/code/pnet_fork/scriptsk/bc/PBS_scripts/get_gpu.py)
...
# SCRIPT
python /shares/CIBIO-Storage/BCG/scratch/kmarita/code/pnet_fork/scriptsk/bc/bc_phenotypes.py \
